...
if __name__ == '__main__':
    ...
    """with io.open("mononokeAFiche.json",encoding="utf-8") as animeData:
    ...
    with io.open("versaillesFiche.json",encoding="utf-8") as mangaData:
        data = json.load(mangaData)
    mangaFiche = ""
    ...
    print("\t\t[\"volumes\"] = %s,"%(str(data["volumes"])))
    print("\t\t[\"chapters\"] = %s,"%(data["chapters"]))
