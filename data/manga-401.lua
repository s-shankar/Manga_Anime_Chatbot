...
This manga, as said at the beginning, is timeless. It will stay with you for quite a while, and it's safe to say it can easily become a favourite. Definitely check this out for a meditation on humanity's place in the world set to the backdrop of gory alien horror.\
  ...
  characters = {
    [1] = {
      firstname = "Shinichi",
      description = "Age: 16-18 Birthday: May 17\
 Zodiac Sign: Taurus\
 Height: 170 cm-178.8 cm\
 Eye:\9Brown (Black in the Manga)\
 \
...
",
 ...
 As the series goes along, however, he becomes more human, whereas the reverse happens to Shinichi.\
 (Source: Wikipedia)\
\
",
      lastname = "Migi",
...
",
    ...
    [7] = {
      firstname = "Taku",
      description = "A Student that likes Murano Satomi.",
      lastname = "Furudani",
      role = "Supporting",
      nicknames = {
        [1] = "Taku  Furudani",
    ...
    [8] = {
      firstname = "Gotou",
      description = "Gotou is an experimental Parasite created by Reiko. He is actually composed of several combined Parasites, whose shapeshifting ability has advanced to the point where they can switch positions, each forming a different limb as the situation requires. \
 He is the most intelligent and skilled, and is the de facto leader of the composite body. Because his head and all of his limbs are made of Parasite cells, Gotō is much faster, stronger, and more dangerous than standard Parasites, and nearly impossible to injure. The name \"Gotou\" is a pun on a word \"五 Go\" meaning number 5, implying he can control 5 Parasites, whereas the other Parasyte in the same body called Miki (三木 Miki lit. three trees) can control only 3. \
 \
 (Source: Wikipedia)\
\
",
    ...
    [9] = {
      firstname = "Makiko",
      description = "Student of Sakurazaki Middle School. She meets Shinichi on a boat and asks if he needs help, and is revealed to be the daughter of the owner of the hotel he stays at.",
      lastname = "Hayase",
      role = "Supporting",
      nicknames = {
        [1] = "Makiko \"Maki-chan\" Hayase",
      },
    },
    [10] = {
      firstname = "Hikawa",
    ...
    [11] = {
      firstname = "Hirama",
      description = "Police officer running the parasites investigations and is under orders of Chief Urashima Kanzaki.",
      lastname = "Hirama",
      role = "Supporting",
      nicknames = {
        [1] = "Hirama",
...
",
    ...
    [14] = {
      firstname = "Nobuko",
      description = "Age: 40 \
 Shinichi's mother who is a housewife.\
 \
 She \"dies\" early on when she is taken over by a Parasite, and stabs Shinichi through the heart when he refuses to accept it; she is then killed later on by a tag team of Shinichi and Uda.\
 (Source: Wikipedia)\
\
",
      lastname = "Izumi",
    ...
    [15] = {
      firstname = "Kazuyuki",
      description = "Age: 44 \
 Shinichi's father who is a photographer. In the past, he was a magazine reporter.\
\
",
      lastname = "Izumi",
      role = "Supporting",
    ...
    [16] = {
      firstname = "Joe",
      description = "He's a parasite that infected Uda's neck and jaw. Uda's Parasite originally does not have a name, but is later renamed Joe. He is brash and crude - it even seems to have a sense of humour, and sometimes assumes control of Uda's mouth, distorting it into odd shapes and forcing Uda to say strange or inappropriate things.  \
 (Source: Wikipedia)\
\
",
      lastname = "Joe",
    ...
    [19] = {
      firstname = "Kana",
      description = "Kana is a disobedient \"bad girl\" who develops a crush on Shinichi. She is attracted to him because of his sensitive personality, and because she can sense something \"different\" about him. In reality, Kana has an unexplained psychic ability to sense Parasites.  \
 However, her senses are not as fine-tuned as those of the Parasites themselves, and she cannot tell whether she is sensing the presence of Shinichi or of a normal Parasite, putting her in considerable danger. \
 \
 Her ability to sense Parasitic signals ends up getting her killed in episode 12 after she follows the signal towards a parasite she had mistaken for Shinichi.\
 (Source: Wikipedia) \
\
",
      lastname = "Kimishima",
...
",
    ...
    [21] = {
      firstname = "Shirou",
      description = "Private Detective. 34 years old. Afficionade for detective books. \
 Ryoko Tamiya hired him to investigate Shinichi Izumi. \
 \
  Later, his wife and daughter are killed by parasites. This makes him kidnap Ryoko Tamiya. He is killed by her after attempting to kill her baby.\
\
",
      lastname = "Kuramori",
      role = "Supporting",
      nicknames = {
        [1] = "Shirou \"Sherlock Holmes\" Kuramori",
      },
    },
    [22] = {
      firstname = "Kusano",
    ...
    [23] = {
      firstname = "Miki",
      description = "He is a parasite that can make a lot of expressions and is talkative. \
 He shares his host with five other parasytes.\
\
",
      lastname = "Miki",
      role = "Supporting",
    ...
    [24] = {
      firstname = "Mitsuo",
      description = "A student at Kita High School who likes Kana. He gets jealous and beats up Shinichi.",
      lastname = "Mitsuo",
      role = "Supporting",
      nicknames = {
        [1] = "Mitsuo",
    ...
    [25] = {
      firstname = "Mitsuyo",
      description = "Old Lady that helps Izumi Shinichi at the end of the story.",
      lastname = "Mitsuyo",
      role = "Supporting",
      nicknames = {
        [1] = "Mitsuyo",
    ...
    [26] = {
      firstname = "Satomi",
      description = "Shinichi's best friend and sometime companion. Shinichi and Satomi develop a romantic relationship over the course of the series, but their attraction to and fondness for one another is hampered by Shinichi's fear of his own monstrous nature, and Satomi's fear of Shinichi's secretive behavior and the mood swings that result from the trials and tribulations in his life. \
...
",
    ...
    [27] = {
      firstname = "Kazuki",
      description = "Student of the same school that Shinichi.",
      lastname = "Nagai",
      role = "Supporting",
      nicknames = {
        [1] = "Kazuki  Nagai",
    ...
    [33] = {
      firstname = "Sasaki",
      description = "A teacher in Shinichi's High-school.",
      lastname = "Sasaki",
      role = "Supporting",
      nicknames = {
        [1] = "Sasaki",
...
",
    ...
    [35] = {
      firstname = "Yuuko",
      description = "A student who discovers that Hideo Shimada is a parasite.",
      lastname = "Tachikawa",
      role = "Supporting",
      nicknames = {
        [1] = "Yuuko  Tachikawa",
    ...
    [37] = {
      firstname = "Ryouko",
      description = "Age: 31 \
 Shinichi's substitute math teacher. She is infected with a parasite.\
 \
 It is later revealed that she is pregnant with a human baby. At first, she plans on experimenting with the child to further extend her knowledge of humans. Although, she develops emotions&mdash;love, even&mdash;for her child as the story progresses, and protects the child until her last dying breath. She voluntarily gives her child to Shinichi after realizing what it means to be a mother and have human emotions. She then dies as a result of multiple gunshots from Hirama and the other investigators, although she would have survived if she had fled or protected herself.\
\
",
      lastname = "Tamiya",
      role = "Supporting",
      nicknames = {
        [1] = "Ryouko \"Reiko Tamura\" Tamiya",
      },
    },
    [38] = {
      firstname = "Mother",
...
",
    ...
    [42] = {
      firstname = "Uragami",
      description = "Serial killer that can sense parasites.",
      lastname = "Uragami",
      role = "Supporting",
      nicknames = {
        [1] = "Uragami",
    ...
    [44] = {
      firstname = "Yamagishi",
      description = "An officer assigned to the Parasyte Extermination Squad. \
 He is killed by Gotou.\
\
",
      lastname = "Yamagishi",
      role = "Supporting",
...
",
    ...
    [46] = {
      firstname = "Yui",
      description = "The scientist that first studies a parasite corpse. ",
      lastname = "Yui",
      role = "Supporting",
      nicknames = {
        [1] = "Yui",
